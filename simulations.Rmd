...
marginals <- list(qplot(gibbs_sample$x, geom="histogram", bins = 50, color = I("violet")),
                  qplot(gibbs_sample$p, geom="histogram", bins = 30, color = I("violet")),
                  qplot(gibbs_sample$n, geom="histogram", bins = 50, color = I("violet"))
)
