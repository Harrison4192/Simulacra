...
-accept-reject using a gamma(4,7) candidate

-Metropolis-Hastings using a gamma(4,7) candidate

-Metropolis-Hastings using a gamma(5,6) candidate
...
main="a: Accept-Rej with Ga(4.7) proposal")
...
hist(X,freq=FALSE,xlab="",ylab="",col="wheat2",
main="b: Met-Hast with Ga(4,7) proposal")
curve(dgamma(x,4.3,6.2),lwd=2,col="sienna",add=T)
...
hist(X,freq=FALSE,xlab="",ylab="",col="wheat2",
main="c: Met-Hast with Ga(5,6) proposal")
curve(dgamma(x,4.3,6.2),lwd=2,col="sienna",add=T)
